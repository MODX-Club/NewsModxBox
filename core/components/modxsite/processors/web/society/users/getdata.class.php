...
require_once dirname(dirname(dirname(dirname(__FILE__)))) . '/site/web/getdata.class.php';

class modWebSocietyUsersGetdataProcessor extends modSiteWebGetdataProcessor{
    ...
    public function afterIteration( array $list){
        ...
        $avatars_url = $this->getSourcePath($this->modx->getOption('modavatar.default_media_source', null, 1));
         
        foreach($list as & $l){
            if(empty($l['photo'])){
                $l['photo'] = "avatarDefault.png";
            }
